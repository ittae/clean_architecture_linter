...
class DomainPurityRule extends DartLintRule {
  ...
  static const _code = LintCode(
    ...
    correctionMessage: 'Remove dependencies on UI frameworks, HTTP clients, databases, or platform-specific APIs. Use abstractions instead.',
  );
    ...
    for (final framework in uiFrameworks) {
      if (importUri.startsWith(framework)) {
        return DomainViolation(
          ...
          suggestion: 'Domain layer should not depend on UI frameworks. Use abstractions or move this logic to presentation layer.',
        );
      }
    }
