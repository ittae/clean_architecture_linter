...
''',
    ...
    test(
      'reports state read inside a Stream.listen callback after the gap',
      () async {
        final result =
            await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule()).analyze(
              files: {
...
''',
    ...
    test(
      'reports unguarded state assignment inside a private async method',
      () async {
        final result =
            await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule()).analyze(
              files: {
...
''',
    ...
    test(
      'does not report a guarded state assignment inside a private async method',
      () async {
        final result =
            await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule()).analyze(
              files: {
...
''',
    ...
    test(
      'reports the inner write of an async private method, not the call',
      () async {
        final result =
            await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule()).analyze(
              files: {
...
''',
    ...
    test(
      'does not report an async private call whose body guards state',
      () async {
        final result =
            await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule()).analyze(
              files: {
...
''',
    ...
    test('reports a sync private call after await at the call site', () async {
      final result = await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule())
          .analyze(
            files: {
              'lib/features/todo/presentation/providers/todo_notifier.dart': '''
...
''',
    ...
    test('reports state = sync private call once, on the assignment', () async {
      final result = await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule())
          .analyze(
            files: {
              'lib/features/todo/presentation/providers/todo_notifier.dart': '''
...
''',
    ...
    test('reports a read-only sync private call as a state read', () async {
      final result = await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule())
          .analyze(
            files: {
              'lib/features/todo/presentation/providers/todo_notifier.dart': '''
...
''',
    ...
    test(
      'does not report a sync private call guarded right after the await',
      () async {
        final result =
            await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule()).analyze(
              files: {
...
''',
    ...
    test(
      'does not report a sync private call whose body guards state',
      () async {
        final result =
            await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule()).analyze(
              files: {
...
''',
    ...
    test(
      'does not report a sync private call guarded by if (ref.mounted)',
      () async {
        final result =
            await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule()).analyze(
              files: {
...
''',
    ...
    test(
      'reports a sync private call when state is written before its guard',
      () async {
        final result =
            await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule()).analyze(
              files: {
...
''',
    ...
    test('does not report a sync private call before the await', () async {
      final result = await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule())
          .analyze(
            files: {
              'lib/features/todo/presentation/providers/todo_notifier.dart': '''
...
''',
    ...
    test(
      'does not report other._apply() as this notifier\'s private call',
      () async {
        final result =
            await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule()).analyze(
              files: {
...
class TodoNotifier extends _\$TodoNotifier {
  Future<void> start(Other other) async {
    await fetch();
    other._apply();
  }
...
''',
    ...
    test(
      'reports a sync private call in the same expression after await',
      () async {
        final result =
            await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule()).analyze(
              files: {
...
''',
    ...
    test(
      'reports a sync private call whose argument awaits before the body',
      () async {
        final result =
            await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule()).analyze(
              files: {
...
''',
    ...
    test(
      'does not report a sync private call before a later argument await',
      () async {
        final result =
            await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule()).analyze(
              files: {
...
''',
    ...
    test(
      'reports a sync private argument await after a preceding mounted guard',
      () async {
        final result =
            await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule()).analyze(
              files: {
...
''',
    ...
    test(
      'reports state read inside a Timer callback of a private method once',
      () async {
        final result =
            await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule()).analyze(
              files: {
...
''',
    ...
    test(
      'does not report ref.read inside a private method from the state rule',
      () async {
        final result =
            await V2RuleHarness(rule: RiverpodStateAfterAsyncGapRule()).analyze(
              files: {
